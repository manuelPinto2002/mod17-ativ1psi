...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Fev-2021 às 17:30
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tipo_user` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
...
(3, 'Manuel Pinto', 'manelpinto8@gmail.com', NULL, '$2y$10$qFgALnEP47ZpfJmDTVGlu.TzS3/v213cuvEhDLVOc7Rz6nRDFEMWK', '', '2021-02-08 08:49:01', '2021-02-08 08:49:01', 'admin');
